          ...
          <ConvertTemplate
            ...
            content={
              <Box textAlign="center">
                <img
                  src={require('@/statics/image/convert/61.png')}
                  width="80%"
                />
                <img
                  src={require('@/statics/image/convert/62.png')}
                  width="80%"
                />
                <img
                  src={require('@/statics/image/convert/63.png')}
                  width="80%"
                />
                <img
                  src={require('@/statics/image/convert/64.png')}
                  width="80%"
                />
              </Box>
            }
